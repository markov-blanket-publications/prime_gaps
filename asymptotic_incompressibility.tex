...
A useful interpretation of (19) is that the sample-complexity of an approximately correct primality test is infinite and therefore it is not learnable. Moreover, given that the prime numbers are the only known rare-event process with a distribution satisfying (4): 
